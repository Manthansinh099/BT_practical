App = {
    ...
    render: function() {
      ...
      App.contracts.manthanTokenSale.deployed().then(function(instance) {
        manthanTokenSaleInstance = instance;
        return manthanTokenSaleInstance.tokenPrice();
      }).then(function(tokenPrice) {
        App.tokenPrice = tokenPrice;
        $('.token-price').html(web3.fromWei(App.tokenPrice, "ether").toNumber());
        return manthanTokenSaleInstance.tokensSold();
        ...
        // Load token contract
        App.contracts.manthanToken.deployed().then(function(instance) {
